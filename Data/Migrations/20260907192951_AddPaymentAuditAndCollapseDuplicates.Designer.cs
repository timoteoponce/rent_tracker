...
namespace RentTracker.Web.Data.Migrations
{
    ...
    [Migration("20260907192951_AddPaymentAuditAndCollapseDuplicates")]
    partial class AddPaymentAuditAndCollapseDuplicates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentTracker.Web.Models.NotificationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RentTracker.Web.Models.PaymentAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RentTracker.Web.Models.PushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RentTracker.Web.Models.WhatsAppSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("DryRunPhoneNumber")
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");

                    b.Property<int>("DueSoonDaysBefore")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EnableIncomingBot")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EnableOverdueToLender")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EnableOverdueToTenant")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EnablePaymentDueSoon")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EnablePaymentOverdue")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EnablePaymentToday")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RentTracker.Web.Models.PaymentAudit", b =>
                {
                    b.HasOne("RentTracker.Web.Models.Payment", "Payment")
            ...
            modelBuilder.Entity("RentTracker.Web.Models.Property", b =>
                {
                    b.HasOne("RentTracker.Web.Models.User", "LastEditedBy")
                        .WithMany("LastEditedProperties")
            ...
            modelBuilder.Entity("RentTracker.Web.Models.PushSubscription", b =>
                {
                    b.HasOne("RentTracker.Web.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("RentTracker.Web.Models.User", b =>
                {
                    b.Navigation("LastEditedProperties");
